...
# place. After the second pass, the next largest is in place. This process continues and requires n−1 passes
...
___ selection_sort(arr
    ...
    ___ fillslot __ r..(l..(arr)-1,0,-1
        ...
        temp _ arr[fillslot]
        arr[fillslot] _ arr[positionOfMax]
        arr[positionOfMax] _ temp

arr _ [3,5,2,7,6,8,12,40,21]
selection_sort(arr)
arr
