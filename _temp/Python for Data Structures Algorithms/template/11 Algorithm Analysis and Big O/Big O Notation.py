...
n _ np.linspace(1,10,1000)
labels _ ['Constant','Logarithmic','Linear','Log Linear','Quadratic','Cubic','Exponential']
big_o _ [np.ones(n.shape),np.log(n),n,n*np.log(n),n**2,n**3,2**n]
