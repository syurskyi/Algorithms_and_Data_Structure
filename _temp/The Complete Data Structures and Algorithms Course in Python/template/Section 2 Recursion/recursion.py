...
___ factorial(n
    assert n >_ 0 ___ int(n) __ n, 'The number must be positive integer only!'
    __ n __ [0,1]:
        r_ 1
    ____
        r_ n * factorial(n-1)
...
___ fibonacci(n
    assert n >_0 ___ int(n) __ n , 'Fibonacci number cannot be negative number or non integer.'
    __ n __ [0,1]:
        r_ n
    ____
